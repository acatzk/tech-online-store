  ...
  return (
    <React.Fragment>
      <header className="sticky top-0 overflow-x-hidden transition-all ease-in-out duration-300 z-10">
        ...
        <AboutCompanySchedule
          isSchedule={isSchedule}
          setIsSchedule={setIsSchedule}
        />

        {/* This is the Main header */}
        <section className="bg-color-3 lg:bg-white/90 lg:hover:bg-white border-b border-transparent lg:border-b-gray-200 px-4 py-3 transition ease-in-out duration-150">
...
function AboutCompanySchedule({ isSchedule, setIsSchedule }) {
  return (
